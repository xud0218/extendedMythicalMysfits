...
#  increment the number of dislikes for the provided mysfit.
@app.route("/mysfits/<mysfitId>/dislike", methods=['POST'])
def dislikeMysfit(mysfitId):
    serviceResponse = mysfitsTableClient.dislikeMysfit(mysfitId)
...
# increment the feed count for the provided mysfit
@app.route("/mysfits/<mysfitId>/feed", methods=['POST'])
def feedMysfit(mysfitId):
    serviceResponse = mysfitsTableClient.feedMysfit(mysfitId)
