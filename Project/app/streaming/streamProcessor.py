...
def retrieveMysfit(mysfitId):
    apiEndpoint = 'https://REPLACE_ME_WITH_API.execute-api.us-east-1.amazonaws.com/prod' + '/mysfits/' + str(mysfitId) # eg: 'https://ljqomqjzbf.execute-api.us-east-1.amazonaws.com/prod/'
